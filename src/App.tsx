...
const App: React.FC = () => {
  ...
  // Try to load the user from localStorage on mount
  useEffect(() => {
  ...
  // Function to update the user state and localStorage when logging in
  const handleSetUser = (userData: { username: string; email?: string }) => {
    setUser(userData);
    localStorage.setItem('user', JSON.stringify(userData));
  };

  // Logout: Sign out from Firebase, clear state and localStorage
